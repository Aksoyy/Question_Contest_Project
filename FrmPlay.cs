...
namespace QuizGame
{
    public partial class FrmPlay : Form
    {
        ...
        {
            listCategory.Clear();
            listCategory.Add(new IdName(0, "Teknoloji"));
            listCategory.Add(new IdName(1, "Tarih"));
            listCategory.Add(new IdName(2, "Spor"));
        ...
        private void ListDifficultyLoad()
        {
            ...
            listDifficulty.Add(new IdName(0, "Kolay"));
            listDifficulty.Add(new IdName(1, "Orta"));
            listDifficulty.Add(new IdName(2, "Zor"));
        ...
        private bool CheckCorrectAnswer(int answer)
        {
            ...
            {
                txtMessage.Text = "Yanlış Cevap Verdiniz !     " + "Doğru Cevap:     " + (char)((int)'A' + currentQuestion.correctAnswer) + ". " +
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                txtQuestion.Text = "";
                txtMessage.Text = "Bu kategorideki tüm soruları cevapladın.";
                BtnNext.Enabled = true;
            }
            else
            {
                count++;
                lblCount.Text = "Soru: " + count.ToString();
                EnableButtons(true);
            }
        }
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            totalTime--;
            lblTimer.Text = "Süre: " + totalTime.ToString();
            if (totalTime <= 5)
            {
            ...
            if (totalTime <= 0)
            {
                ...
                EnableButtons(false);
                txtQuestion.Text = "";
                txtMessage.Text = "Süren bitti !  Lütfen diğer soruya geçin.";
                lifes--;
                CheckLifes();
                if (lifes == 0)
                {
